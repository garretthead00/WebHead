<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="UnderReview.aspx.vb" Inherits="NOT_UnderReview" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="../Styles/NonOpTime.css" rel="stylesheet"/>
    <link href="../Styles/NOTUnderReview.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    ...
    <script src="../Scripts/NOTUnderReview.js" type="text/javascript"></script>
</asp:Content>
